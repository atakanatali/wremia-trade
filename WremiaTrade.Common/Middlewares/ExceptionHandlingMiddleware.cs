...
using Papara.Common.ApiHelpers.ApiExceptionHandling;
using Papara.Logging.ElasticSearch;
using Papara.RestSharpClient.Exceptions;
using Papara.Services.Abstraction;
using Papara.Common.ApiHelpers;

namespace Papara.Common.Middlewares
{
    public class ExceptionHandlingMiddleware
    {
        private string[] _ignoredLogFields;
        private string[] _maskedLogFields;
